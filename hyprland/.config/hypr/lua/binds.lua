...
local specialBinds = {
    ...
    H = hl.dsp.focus({direction = "left"}), -- Try switching left, right, up, down to l, r, u, d
    L = hl.dsp.focus({direction = "right"}),
    K = hl.dsp.focus({direction = "up"}),
    J = hl.dsp.focus({direction = "down"}),
    ["SHIFT + H"] = hl.dsp.window.move({direction = "left"}), -- Try switching left, right, up, down to l, r, u, d
